...
class GlowWalletAdapter extends wallet_adapter_base_1.BaseMessageSignerWalletAdapter {
    constructor(_config = {}) {
        ...
        this._wallet = null;
        this._publicKey = null;
        this._network = (_a = _config.network) !== null && _a !== void 0 ? _a : null;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                try {
                    ...
                    const { signature } = yield wallet.signAndSendTransaction(transaction, Object.assign(Object.assign({}, sendOptions), { network: this._network }));
                    return signature;
                }
                catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!wallet)
                    throw new wallet_adapter_base_1.WalletNotConnectedError();
                try {
                    return (yield wallet.signTransaction(transaction, this._network)) || transaction;
                }
                catch (error) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!wallet)
                    throw new wallet_adapter_base_1.WalletNotConnectedError();
                try {
                    return (yield wallet.signAllTransactions(transactions, this._network)) || transactions;
                }
                catch (error) {
                    throw new wallet_adapter_base_1.WalletSignTransactionError(error === null || error === void 0 ? void 0 : error.message, error);
                }
